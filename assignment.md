# Task Management System - Assignment Requirements
...
Filtering and pagination should preferably be handled through the backend API rather than loading all records into the frontend.
...
At a minimum, include the following tables:
...
These features are optional and can be implemented if time permits:
